...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/jquery.dataTables.min.css"> <!-- Changed from CDN -->
</head>
<body>
    ...
    <script src="../../assets/js/jquery-3.5.1.min.js"></script> <!-- Changed from CDN -->
    <script src="../../assets/js/jquery.dataTables.min.js"></script> <!-- Changed from CDN -->
